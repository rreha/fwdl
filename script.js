...
ofwsel.on("change", () => {
    ...
    if (ofwval == 3) { // 6.39 from my DropBox
    ...
    if (ofwval == 4) { // 6.35 from my DropBox
    ...
    if (ofwval == 5) { // 6.20 from my DropBox
...
cfwsel.on("change", () => {
    ...
    if (cfwval == 1 && ofwval == 1 || ofwval == 2) { // 6.61 & 6.60 ARK-4 from GitHub
        $(".cfw-dl > a").prop("href", "https://github.com/PSP-Archive/ARK-4/releases/download/r42069/ARK4.zip")
    }

    if (cfwval == 2 && ofwval == 1) { // 6.61 PRO-C from my DropBox
    ...
    if (cfwval == 3 && ofwval == 1) { // 6.61 (L)ME from my DropBox
    ...
    if (cfwval == 2 && ofwval == 2) { // 6.60 PRO-C from my DropBox
    ...
    if (cfwval == 3 && ofwval == 2) { // 6.60 (L)ME from my DropBox
    ...
    if (cfwval == 2 && ofwval == 3) { // 6.39 PRO-C from my DropBox
    ...
    if (cfwval == 3 && ofwval == 3) { // 6.39 (L)ME from my DropBox
    ...
    if (cfwval == 2 && ofwval == 4) { // 6.35 PRO-C from my DropBox
    ...
    if (cfwval == 2 && ofwval == 5) { // 6.20 PRO-C from my DropBox
    ...
    if (cfwval == 3 && ofwval == 5) { // 6.20 (L)ME from my DropBox
